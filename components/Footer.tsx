...
const Footer = () => {
  return (
    <footer>
      <div className='bg-[#151515] max-w-100vw mx-auto p-6 sm:px-8 lg:px-12 text-center !mt-auto'>
        <div className='flex flex-col max-w-7xl gap-3 justify-between mx-auto sm:px-10 lg:px-18 sm:flex-row'>
